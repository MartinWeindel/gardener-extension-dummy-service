...
import (
	...
	serviceinstall "github.com/MartinWeindel/gardener-extension-dummy-service/pkg/apis/service/install"
...
// NewServiceControllerCommand creates a new command that is used to start the Dummy Service controller.
func NewServiceControllerCommand() *cobra.Command {
	options := NewOptions()

	cmd := &cobra.Command{
		Use:           "dummy-service-controller-manager",
		Short:         "Dummy Service Controller manages components which provide dummy services.",
		SilenceErrors: true,
...
func (o *Options) run(ctx context.Context) error {
	...
	ctrlConfig := o.dummyOptions.Completed()
	...
	o.lifecycleControllerOptions.Completed().Apply(&lifecycle.DefaultAddOptions.ControllerOptions)
	o.healthOptions.Completed().Apply(&healthcheck.DefaultAddOptions.Controller)
	reconcilerConfig := o.reconcileOptions.Completed()
	reconcilerConfig.Apply(&lifecycle.DefaultAddOptions.IgnoreOperationAnnotation, &lifecycle.DefaultAddOptions.ExtensionClass)
